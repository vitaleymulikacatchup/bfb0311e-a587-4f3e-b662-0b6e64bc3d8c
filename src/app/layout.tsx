...
export const metadata: Metadata = {
  title: "RPRT Sports + Talent Management | Elite Hollywood Talent Agency",
  description: "Premier talent management for elite athletes and entertainers. Comprehensive services including career management, PR, contract negotiations, and Hollywood brand development.",
  keywords: "talent management, sports management, Hollywood talent agency, entertainment industry, celebrity management, product placement, brand development, contract negotiations",
  openGraph: {
    title: "RPRT Sports + Talent Management | Elite Hollywood Talent Agency",
    description: "Premier talent management for elite athletes and entertainers in Hollywood",
  ...
  twitter: {
    ...
    title: "RPRT Sports + Talent Management",
    description: "Elite talent management and entertainment services in Hollywood",
